...
class NewFetchTests(unittest.TestCase, IMAP4HelperMixin):
    ...
    def testFetchFull(self, uid=0):
        ...
        self.expected = {
            0: {'FLAGS': ['\\XYZ', '\\YZX', 'Abc'],
                ...
                'RFC822.SIZE': '6',
                'ENVELOPE': [None, None, [[None, None, None]], [[None, None, None]], None, None, None, None, None,
                             None],
    ...
    def testFetchAll(self, uid=0):
        ...
        self.expected = {
            0: {'ENVELOPE': [None, None, [[None, None, None]], [[None, None, None]], None, None, None, None, None,
                             None],
                'RFC822.SIZE': '6',
                'INTERNALDATE': '14-Apr-2003 19:43:44 +0400',
                'FLAGS': []},
            1: {'ENVELOPE': [None, None, [[None, None, None]], [[None, None, None]], None, None, None, None, None,
                             None],
                'RFC822.SIZE': '6',
