...
class VT100Frame(Tkinter.Frame):
    ...
    def _write(self, ch, fg, bg):
        ...
        if bg:
            self.canvas.create_rectangle(canvasX, canvasY, canvasX + fontWidth - 1, canvasY + fontHeight - 1, fill=bg,
                                         outline=bg)
    ...
    def write(self, data):
        ...
        canvasX = self.x * fontWidth + 1
        canvasY = self.y * fontHeight + 1
        self.cursor = self.canvas.create_rectangle(canvasX, canvasY, canvasX + fontWidth - 1, canvasY + fontHeight - 1,
